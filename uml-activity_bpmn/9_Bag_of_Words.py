...
# Créer une liste combinée de tous les éléments
all_elements = list(uml_activity_elements.values()) + list(bpmn_elements.values())

# Utiliser CountVectorizer pour transformer les textes en vecteurs Bag of Words
vectorizer = CountVectorizer()
X = vectorizer.fit_transform(all_elements)

# Calculer la similarité cosine entre les vecteurs
