...
# Convert attribute lists to strings for vectorization
...
# Extract TF-IDF vectors for UML and C#
tfidf_uml = X[:n_uml]
tfidf_csharp = X[n_uml:]

# Calculate cosine similarity
similarity_matrix = cosine_similarity(tfidf_uml, tfidf_csharp)
